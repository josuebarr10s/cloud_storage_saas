...
export const BentoFeatures = () => {
  ...
  return (
    <section id="features" style={{ padding: '5.5rem 0', background: '#f8fafc', borderTop: '1px solid #e2e8f0' }}>
        ...
        >
          ...
          >
            <div>
              ...
              <p style={{ color: '#64748b', fontSize: '0.95rem', maxWidth: '580px', lineHeight: 1.6 }}>
            ...
            >
              <div>
                <p style={{ fontSize: '0.72rem', color: '#64748b', textTransform: 'uppercase', fontWeight: 600 }}>Carga Paralela</p>
                <p style={{ fontSize: '1.15rem', fontWeight: 700, color: '#10b981', marginTop: '2px' }}>Multi-Chunk</p>
              </div>
              <div>
                <p style={{ fontSize: '0.72rem', color: '#64748b', textTransform: 'uppercase', fontWeight: 600 }}>Cifrado de Objetos</p>
                <p style={{ fontSize: '1.15rem', fontWeight: 700, color: '#4f46e5', marginTop: '2px' }}>AES-256</p>
              </div>
              <div>
                <p style={{ fontSize: '0.72rem', color: '#64748b', textTransform: 'uppercase', fontWeight: 600 }}>Disponibilidad SLA</p>
                <p style={{ fontSize: '1.15rem', fontWeight: 700, color: '#0284c7', marginTop: '2px' }}>99.99%</p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div style={{ background: '#f8fafc', padding: '12px', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
                <span style={{ fontSize: '0.8rem', color: '#334155', display: 'flex', alignItems: 'center', gap: '6px', fontWeight: 500 }}>
                  <Lock size={13} color="#0284c7" /> Proteger con PIN
                </span>
                <button
                  ...
                  style={{
                    ...
                    height: '18px',
                    borderRadius: '12px',
                    background: demoProtectedLink ? '#0284c7' : '#cbd5e1',
                    position: 'relative',
                  }}
                >
                  <div
              ...
              <div>
                <p style={{ fontSize: '0.72rem', color: '#64748b', marginBottom: '4px' }}>Caducidad:</p>
                  ...
                  {['1h', '24h', '7 días', 'Nunca'].map((time) => (
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: '6px',
                        fontWeight: 600,
                        background: demoExpiry === time ? '#e0f2fe' : '#ffffff',
                        color: demoExpiry === time ? '#0369a1' : '#64748b',
                        border: demoExpiry === time ? '1px solid #0284c7' : '1px solid #e2e8f0',
                      }}
                    >
                      {time}
                    </button>
          ...
          >
            ...
            <div style={{ marginTop: '1.25rem', display: 'flex', flexDirection: 'column', gap: '6px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 12px', background: '#f8fafc', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                <span style={{ fontSize: '0.78rem', color: '#0f172a', fontWeight: 500 }}>Versión 2.0 (Actual)</span>
                <span style={{ fontSize: '0.72rem', color: '#059669', fontWeight: 600, background: '#ecfdf5', padding: '2px 6px', borderRadius: '4px' }}>Activa</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 12px', background: '#f8fafc', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                <span style={{ fontSize: '0.78rem', color: '#64748b' }}>Versión 1.0 (Ayer)</span>
                <span style={{ fontSize: '0.72rem', color: '#4f46e5', fontWeight: 600, cursor: 'pointer' }}>Restaurar</span>
              </div>
            </div>
          </div>
              ...
              {['todos', 'PDFs', 'Imágenes', 'Videos', 'ZIPs'].map((tag) => (
                <button
                  ...
                  style={{
                    ...
                    fontSize: '0.75rem',
                    fontWeight: 500,
                    background: demoSearchTag === tag ? '#4f46e5' : '#f1f5f9',
                    color: demoSearchTag === tag ? '#ffffff' : '#64748b',
                  }}
                >
                  {tag}
                </button>
          ...
          >
            ...
            <div style={{ marginTop: '1.25rem', padding: '10px 12px', background: '#fffbeb', borderRadius: '8px', border: '1px solid #fef3c7', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <Eye size={15} color="#d97706" />
              <span style={{ fontSize: '0.75rem', color: '#92400e', fontWeight: 500 }}>Streaming directo con soporte H.264</span>
            </div>
          </div>
        </div>
      </div>
